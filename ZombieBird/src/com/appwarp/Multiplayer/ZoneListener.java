...
public class ZoneListener implements ZoneRequestListener{
	...
	public void onCreateRoomDone (RoomEvent re) {
		System.out.println("ZOLI: onCreateRoom");
	...
	public void onDeleteRoomDone (RoomEvent arg0) {
		System.out.println("ZOLI: del room");
	}

	@Override
	public void onGetAllRoomsDone (AllRoomsEvent arg0) {
		if(arg0!=null){
			String[] ids = arg0.getRoomIds();
			if(ids!=null){
				callBack.roomIDs=Arrays.asList(arg0.getRoomIds());
			}
	...
	public void onGetOnlineUsersDone (AllUsersEvent arg0) {
		callBack.onlineUsers = arg0.getUserNames();
	}
